...
<div class='container2'>
    ...
    <input name='70e_Participants_before_June' type='checkbox' id='70e_Participants_before_June' value='<?php echo $formproc->SafeDisplay('70e_Participants_before_June') ?>' />70 €</div>


<div class='container2'>
    <label for='100e_Participants_after_June' >After June 01, 2013</label><br/>
    <input name='100e_Participants_after_June' type='checkbox' id='100e_Participants_after_June' value='<?php echo $formproc->SafeDisplay('100e_Participants_after_June') ?>' />100 €</div>
<div class="clear"></div>
...
<div class='container4'>
    <label for='100e_Accomodation_Social_before_June' >Before June 01, 2013</label><br/>
    <input name='100e_Accomodation_Social_before_June' type='checkbox' id='100e_Accomodation_Social_before_June' value='<?php echo $formproc->SafeDisplay('100e_Accomodation_Social_before_June') ?>' />100 €</div>


<div class='container4'>
    <label for='150e_Accomodation_Social_after_June' >After June 01, 2013</label><br/>
    <input name='150e_Accomodation_Social_after_June' type='checkbox' id='150e_Accomodation_Social_after_June' value='<?php echo $formproc->SafeDisplay('150e_Accomodation_Social_after_June') ?>' />150 €</div>
<div class="clear"></div>
...
<table border="0" cellpadding="0" cellspacing="0">
 <tr>
                ...
                <td height="157" colspan="4">
                    <blockquote id="tekst">
                      ...
                      <p align="justify"><strong>CONFERENCE CANCELLATION / REFUND POLICY</strong><br />
                        All cancellations made <strong>before June 1st</strong> will be subject to a penalty of 100 €.<br />
                        All cancellations made <strong>after June 1st</strong> will be subject to a penalty of the total amount paid. </p>
                    </blockquote></td>
              </tr>
              <tr>
                <td colspan="4">&nbsp;</td>
              ...
              <tr>
                <td height="52" colspan="4" id="tekst"><p align="left"><span class="style40">NOTE**: </span>Alternatively,  you can <a href="Registration form.pdf" class="style38" id="tekst">download the registration form</a> and submit it via e-mail to:</p>
                		<p align="center"><span class="style39">dvm2013@fvm.ukim.edu.mk</span></p>
                		</td>
              </tr>
              </table>
</div>
